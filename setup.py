...
setup(
  ...
  url = 'https://github.com/dareljohnson/checkexpect-py', # use the URL to the github repo
  download_url = 'https://github.com/dareljohnson/checkexpect-py/tarball/0.1', # I'll explain this in a second

  # What does your project relate to?
  keywords = ['testing', 'algorithm design', 'example','unit testing','TDD','DDD','SPD','HtDD','HtDF'], # arbitrary keywords
